...
#endif
static const char *ng0 = "D:/verilog/P6/if_id.v";
static int ng1[] = {0, 0};
...
LAB76:    memcpy(t225, t203, 8);

LAB77:    memset(t253, 0, 8);
    t254 = (t225 + 4);
...
LAB90:    memcpy(t275, t253, 8);

LAB91:    memset(t303, 0, 8);
    t304 = (t275 + 4);
...
LAB104:    memcpy(t325, t303, 8);

LAB105:    memset(t353, 0, 8);
    t354 = (t325 + 4);
...
LAB118:    memcpy(t375, t353, 8);

LAB119:    t403 = (t0 + 10568);
    xsi_vlogvar_wait_assign_value(t403, t375, 0, 0, 1, 0LL);
    goto LAB13;
...
LAB65:    if (*((unsigned int *)t166) != 0)
        goto LAB66;

LAB67:    t176 = *((unsigned int *)t153);
...
LAB79:    if (*((unsigned int *)t216) != 0)
        goto LAB80;

LAB81:    t226 = *((unsigned int *)t203);
...
LAB93:    if (*((unsigned int *)t266) != 0)
        goto LAB94;

LAB95:    t276 = *((unsigned int *)t253);
...
LAB107:    if (*((unsigned int *)t316) != 0)
        goto LAB108;

LAB109:    t326 = *((unsigned int *)t303);
...
extern void work_m_00000000001976955798_3683593905_init()
{
	static char *pe[] = {(void *)Initial_32_0,(void *)Always_43_1};
	xsi_register_didat("work_m_00000000001976955798_3683593905", "isim/test_isim_beh.exe.sim/work/m_00000000001976955798_3683593905.didat");
