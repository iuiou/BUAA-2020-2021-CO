...
#endif
static const char *ng0 = "D:/verilog/P5/mips.v";
...
LAB49:    if (*((unsigned int *)t99) > 0)
        goto LAB50;

LAB51:    if (*((unsigned int *)t73) > 0)
        goto LAB52;

LAB53:    memcpy(t72, t132, 8);

LAB54:    memset(t133, 0, 8);
    xsi_vlog_unsigned_add(t133, 32, t71, 32, t72, 32);
    goto LAB30;
...
LAB70:    memcpy(t138, t197, 8);

LAB71:    goto LAB32;

LAB33:    xsi_vlog_unsigned_bit_combine(t39, 32, t133, 32, t138, 32);
    goto LAB37;

LAB35:    memcpy(t39, t133, 8);
    goto LAB37;
...
LAB46:    t105 = (t0 + 3288U);
    ...
    *((unsigned int *)t116) = t125;
    ...
    t126 = ((char*)((ng6)));
    memset(t127, 0, 8);
    xsi_vlog_unsigned_lshift(t127, 32, t103, 32, t126, 32);
    goto LAB47;

LAB48:    t132 = ((char*)((ng7)));
    goto LAB49;

LAB50:    xsi_vlog_unsigned_bit_combine(t72, 32, t127, 32, t132, 32);
    goto LAB54;

LAB52:    memcpy(t72, t127, 8);
    goto LAB54;
...
LAB63:    t170 = ((char*)((ng4)));
    ...
    *((unsigned int *)t171) = (t179 & 67108863U);
    t180 = *((unsigned int *)t172);
    *((unsigned int *)t172) = (t180 & 67108863U);
    t182 = (t0 + 3128U);
    t183 = *((char **)t182);
    memset(t181, 0, 8);
    t182 = (t181 + 4);
    ...
    *((unsigned int *)t182) = (t190 & 15U);
    xsi_vlogtype_concat(t169, 32, 32, 3U, t181, 4, t171, 26, t170, 2);
    goto LAB64;
...
LAB65:    t195 = (t0 + 2808U);
    ...
    t195 = ((char*)((ng7)));
    memset(t197, 0, 8);
    xsi_vlog_unsigned_add(t197, 32, t196, 32, t195, 32);
    goto LAB66;

LAB67:    xsi_vlog_unsigned_bit_combine(t138, 32, t169, 32, t197, 32);
    goto LAB71;
...
extern void work_m_00000000004071343183_3877310806_init()
{
	static char *pe[] = {(void *)Cont_75_0,(void *)Cont_80_1,(void *)Cont_132_2,(void *)Cont_166_3,(void *)Cont_167_4,(void *)Cont_184_5,(void *)Cont_187_6,(void *)Cont_190_7,(void *)Cont_193_8,(void *)Cont_196_9};
	xsi_register_didat("work_m_00000000004071343183_3877310806", "isim/test_isim_beh.exe.sim/work/m_00000000004071343183_3877310806.didat");
