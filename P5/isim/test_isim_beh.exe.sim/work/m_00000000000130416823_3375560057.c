...
#endif
static const char *ng0 = "D:/verilog/P5/id_ex.v";
static int ng1[] = {0, 0};
...
LAB50:    memcpy(t6, t72, 8);

LAB51:    t85 = (t0 + 5768);
    xsi_vlogvar_wait_assign_value(t85, t6, 0, 0, 32, 0LL);
...
LAB80:    memcpy(t6, t63, 8);

LAB81:    t80 = (t0 + 5928);
    xsi_vlogvar_wait_assign_value(t80, t6, 0, 0, 5, 0LL);
...
LAB61:    if (*((unsigned int *)t73) > 0)
        goto LAB62;

LAB63:    memcpy(t72, t91, 8);

LAB64:    goto LAB46;

LAB47:    xsi_vlog_unsigned_bit_combine(t6, 32, t62, 32, t72, 32);
    goto LAB51;

LAB49:    memcpy(t6, t62, 8);
    goto LAB51;

LAB52:    *((unsigned int *)t73) = 1;
    goto LAB55;
...
LAB60:    xsi_vlog_unsigned_bit_combine(t72, 32, t86, 32, t91, 32);
    goto LAB64;

LAB62:    memcpy(t72, t86, 8);
    goto LAB64;
...
LAB93:    if (*((unsigned int *)t62) > 0)
        goto LAB94;

LAB95:    if (*((unsigned int *)t64) > 0)
        goto LAB96;

LAB97:    memcpy(t63, t81, 8);

LAB98:    goto LAB76;

LAB77:    xsi_vlog_unsigned_bit_combine(t6, 5, t31, 5, t63, 5);
    goto LAB81;

LAB79:    memcpy(t6, t31, 8);
    goto LAB81;
...
LAB94:    xsi_vlog_unsigned_bit_combine(t63, 5, t74, 5, t81, 5);
    goto LAB98;

LAB96:    memcpy(t63, t74, 8);
    goto LAB98;

}


extern void work_m_00000000000130416823_3375560057_init()
{
	static char *pe[] = {(void *)Initial_37_0,(void *)Cont_56_1,(void *)Cont_57_2,(void *)Cont_58_3,(void *)Cont_59_4,(void *)Cont_60_5,(void *)Cont_63_6,(void *)Cont_64_7,(void *)Cont_65_8,(void *)Always_67_9};
	xsi_register_didat("work_m_00000000000130416823_3375560057", "isim/test_isim_beh.exe.sim/work/m_00000000000130416823_3375560057.didat");
