...
#endif
static const char *ng0 = "D:/verilog/P7/if_id.v";
static int ng1[] = {0, 0};
...
LAB76:    memcpy(t175, t153, 8);

LAB77:    memset(t203, 0, 8);
    t204 = (t175 + 4);
...
LAB104:    memcpy(t275, t253, 8);

LAB105:    memset(t303, 0, 8);
    t304 = (t275 + 4);
...
LAB118:    memcpy(t325, t303, 8);

LAB119:    t353 = (t0 + 11848);
    xsi_vlogvar_wait_assign_value(t353, t325, 0, 0, 1, 0LL);
    goto LAB27;
...
LAB79:    if (*((unsigned int *)t166) != 0)
        goto LAB80;

LAB81:    t176 = *((unsigned int *)t153);
...
LAB93:    if (*((unsigned int *)t216) != 0)
        goto LAB94;

LAB95:    t226 = *((unsigned int *)t203);
...
LAB107:    if (*((unsigned int *)t266) != 0)
        goto LAB108;

LAB109:    t276 = *((unsigned int *)t253);
...
extern void work_m_00000000000686243558_3683593905_init()
{
	static char *pe[] = {(void *)Initial_38_0,(void *)Always_51_1};
	xsi_register_didat("work_m_00000000000686243558_3683593905", "isim/tb_isim_beh.exe.sim/work/m_00000000000686243558_3683593905.didat");
